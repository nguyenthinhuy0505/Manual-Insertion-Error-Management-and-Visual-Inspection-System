...
let InspectionsController = class InspectionsController {
    ...
    findAll(page = '1', limit = '20', location, defectType, isDefective, from, to) {
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('defectType')),
    __param(4, (0, common_1.Query)('isDefective')),
...
__decorate([
    (0, common_1.Post)(':id/incorrect'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], InspectionsController.prototype, "markAsIncorrect", null);
__decorate([
